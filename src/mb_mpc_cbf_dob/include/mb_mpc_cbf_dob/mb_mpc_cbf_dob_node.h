#ifndef MB_MPC_CBF_DOB_INCLUDE_NEW_MPC_CBF_DOB_NODE_H
#define MB_MPC_CBF_DOB_INCLUDE_NEW_MPC_CBF_DOB_NODE_H
#endif
...
{
    class MbMpcCbfDobNode
    {
    public:
        MbMpcCbfDobNode(ros::NodeHandle &nh, double tc);
        void run(void);
